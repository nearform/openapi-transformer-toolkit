...
describe('oas2json', () => {
  test('adaptSchema function', async (t: TestContext) => {
  ...
  describe('runCommand function', () => {
    ...
    test('should generate JSON schema files from the OpenAPI input', async (t: TestContext) => {
    ...
    test('should convert components.schemas automatically', async (t: TestContext) => {
    ...
    test('should dynamically find the name when converting an array property', async (t: TestContext) => {
      ...
      t.assert.deepStrictEqual(generatedFiles, [
        'pet.json',
        'store.json',
        'user.json'
      ])
